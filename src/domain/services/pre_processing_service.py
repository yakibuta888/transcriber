...
class PreprocessingService:
    ...
    def process(self, path: str, progress: ProgressReporter | None = None) -> AudioEntity:
        ...
        torchaudio.save("04_after_vocal_enhancement.wav", enhanced_audio, raw_audio.sample_rate)  # デバッグ用
        plot_audio_analysis(
        ...
        torchaudio.save("05_after_re_normalization.wav", re_normalized_audio, raw_audio.sample_rate)  # デバッグ用
        plot_audio_analysis(
